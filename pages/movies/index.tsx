  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center min-h-screen bg-[#093545]">
        ...
        <h2 className={`text-[#ffffff] ${montserrat.className} text-center text-[32px] mx-[2rem] lg:text-[48px] leading-[40px] lg:leading-[56px] mb-[3rem]`}>Your movie list is empty</h2>
        <button
        onClick={addMovie}
        className={`bg-[#2BD17E] text-[#ffffff] rounded-[10px] ${montserrat.className} text-[16px] font-bold leading-[24px] w-full   lg:w-[220px] h-[56px]`}>Add a new movie</button>
        </div>
        }
        {movies.length>0 && 
         <MovieListing/>
